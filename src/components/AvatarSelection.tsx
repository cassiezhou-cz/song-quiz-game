...
type AvatarType = 'Girl' | 'Boy' | 'Corgi' | 'Cat' | 'Robot' | 'Panda'

const avatars: AvatarType[] = ['Girl', 'Boy', 'Corgi', 'Cat', 'Robot', 'Panda']
          ...
          {avatars.map((avatar) => (
            ...
            >
              <div className="avatar-image-wrapper">
                <img
                  src={`/assets/${avatar}${selectedAvatar === avatar ? 'Happy' : 'Neutral'}.png`}
                  alt={`${avatar} avatar`}
